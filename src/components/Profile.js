...
export default class Profile extends Component {
  ...
  mydata() {
    ...
    if (state.profile_update_ture === false) {
      return (
        <View style={styles.container}>
          <Text style={styles.textView}>Name</Text>
          <TextInput style={styles.input} editable={false} value={state.name} />
          ...
          <TouchableOpacity
            ...
            onPress={this.edit_profile_submit}
          >
        ...
        <ScrollView>
          <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
            <View style={styles.container}>
              ...
              <TouchableOpacity
                style={styles.submitButton}
                onPress={this.cancel_edit_profile_submit}
              >
                <Text style={styles.submitButtonText}> Cancel Update </Text>
              </TouchableOpacity>
            </View>
          </KeyboardAvoidingView>
        </ScrollView>
  ...
  edit_profile_submit = () => {
    this.setState({ profile_update_ture: true });
  };
  cancel_edit_profile_submit = () => {
    this.function_load_data();
    this.setState({ profile_update_ture: false });
  };
